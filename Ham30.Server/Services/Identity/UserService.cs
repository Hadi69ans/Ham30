...
namespace Ham30.Server.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        public async Task<Sheard.Wrapper.IResult> RegisterAsync(RegisterRequest request, string origin)
        {
        ...
        public async Task<Sheard.Wrapper.IResult> ToggleUserStatusAsync(ToggleUserStatusRequest request)
        {
        ...
        public async Task<Sheard.Wrapper.IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
        ...
        public async Task<Sheard.Wrapper.IResult> ForgotPasswordAsync(ForgotPasswordRequest request, string origin)
        {
        ...
        public async Task<Sheard.Wrapper.IResult> ResetPasswordAsync(ResetPasswordRequest request)
        {
            var user = await _userManager.FindByEmailAsync(request.Email);
            if (user == null)
            {
