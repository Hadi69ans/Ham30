...
namespace Ham30.Server.Services.Identity
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<Sheard.Wrapper.IResult> ChangePasswordAsync(ChangePasswordRequest model, string userId)
        {
        ...
        public async Task<Sheard.Wrapper.IResult> UpdateProfileAsync(UpdateProfileRequest request, string userId)
        {
